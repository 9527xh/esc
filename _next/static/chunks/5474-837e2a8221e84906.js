(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[5474], {
    23714: function(t, e, n) {
        "use strict";
        function o(t) {
        ...
        function v(t, e) {
            var n = t.element.classList
              , o = d.scrolling(e);
            n.contains(o) ? clearTimeout(f[e]) : n.add(o)
        }
        function b(t, e) {
        ...
        g.prototype.unbind = function(t, e) {
            ...
            this.handlers[t] = this.handlers[t].filter((function(o) {
                return !(!e || o === e) || (n.element.removeEventListener(t, o, !1),
                !1)
            }
            ))
        }
        ...
        function w(t, e, n, o, r) {
            ...
            !function(t, e, n, o, r) {
                ...
                u[s] > t[i] - t[l] - 1 && (t.reach[a] = "end");
                e && (u.dispatchEvent(Y("ps-scroll-" + a)),
                e < 0 ? u.dispatchEvent(Y("ps-scroll-" + c)) : e > 0 && u.dispatchEvent(Y("ps-scroll-" + h)),
                o && function(t, e) {
                    v(t, e),
                    b(t, e)
                }(t, a));
                t.reach[a] && (e || r) && u.dispatchEvent(Y("ps-" + a + "-reach-" + t.reach[a]))
            }(t, n, i, o, r)
        }
        function X(t) {
        ...
        function S(t) {
            ...
            t.containerWidth = Math.round(o.width),
            t.containerHeight = Math.round(o.height),
            t.contentWidth = e.scrollWidth,
            t.contentHeight = e.scrollHeight,
            e.contains(t.scrollbarXRail) || (c(e, p.rail("x")).forEach((function(t) {
                return a(t)
            }
            )),
            e.appendChild(t.scrollbarXRail)),
            e.contains(t.scrollbarYRail) || (c(e, p.rail("y")).forEach((function(t) {
                return a(t)
            }
            )),
            ...
            t.scrollbarXWidth = T(t, X(t.railXWidth * t.containerWidth / t.contentWidth)),
            ...
            t.scrollbarYHeight = T(t, X(t.railYHeight * t.containerHeight / t.contentHeight)),
            ...
            function(t, e) {
                ...
                e.isScrollbarXUsingBottom ? n.bottom = e.scrollbarXBottom - o : n.top = e.scrollbarXTop + o;
        ...
        function W(t, e) {
            ...
            function y() {
                b(t, c),
                t[h].classList.remove(d.clicking),
                t.event.unbind(t.ownerDocument, "mousemove", m)
            }
            function Y(e, l) {
                p = u[a],
                l && e.touches && (e[r] = e.touches[0].pageY),
                f = e[r],
                g = (t[o] - t[n]) / (t[i] - t[s]),
        ...
        var E = {
            ...
            keyboard: function(t) {
                ...
                t.event.bind(t.ownerDocument, "keydown", (function(n) {
                    if (!(n.isDefaultPrevented && n.isDefaultPrevented() || n.defaultPrevented) && (s(e, ":hover") || s(t.scrollbarX, ":focus") || s(t.scrollbarY, ":focus"))) {
                        var o, r = document.activeElement ? document.activeElement : t.ownerDocument.activeElement;
                        if (r) {
                            if ("IFRAME" === r.tagName)
                            ...
                            if (s(o = r, "input,[contenteditable]") || s(o, "select,[contenteditable]") || s(o, "textarea,[contenteditable]") || s(o, "button,[contenteditable]"))
                                return
                        }
                        var i = 0
                          , l = 0;
                        ...
                        function(n, o) {
                            ...
                            if (0 === n) {
                                if (!t.scrollbarYActive)
                                    return !1;
                                if (0 === r && o > 0 || r >= t.contentHeight - t.containerHeight && o < 0)
                    ...
                    if (!function(t, n, r) {
                        ...
                        for (var i = t; i && i !== e; ) {
                            ...
                            if (r && l.overflowY.match(/(scroll|auto)/)) {
                                ...
                                if (s > 0 && (i.scrollTop > 0 && r < 0 || i.scrollTop < s && r > 0))
                                    return !0
                            }
                        ...
                        var s = !1;
                        t.settings.useBothWheelAxes ? t.scrollbarYActive && !t.scrollbarXActive ? (l ? e.scrollTop -= l * t.settings.wheelSpeed : e.scrollTop += i * t.settings.wheelSpeed,
                        s = !0) : t.scrollbarXActive && !t.scrollbarYActive && (i ? e.scrollLeft += i * t.settings.wheelSpeed : e.scrollLeft -= l * t.settings.wheelSpeed,
                        s = !0) : (e.scrollTop -= l * t.settings.wheelSpeed,
                        e.scrollLeft += i * t.settings.wheelSpeed),
                        S(t),
                        s = s || function(n, o) {
                            var r = Math.floor(e.scrollTop)
                              , i = 0 === e.scrollTop
                              , l = r + e.offsetHeight === e.scrollHeight
                              , s = 0 === e.scrollLeft
                              , a = e.scrollLeft + e.offsetWidth === e.scrollWidth;
                            return !(Math.abs(o) > Math.abs(n) ? i || l : s || a) || !t.settings.wheelPropagation
                        }(i, l),
                        s && !n.ctrlKey && (n.stopPropagation(),
                        n.preventDefault())
                    }
                }
            ...
            touch: function(t) {
                if (R.supportsTouch || R.supportsIePointer) {
                    var e = t.element
                      ...
                      , i = {}
                      , l = null;
                    R.supportsTouch ? (t.event.bind(e, "touchstart", h),
                    t.event.bind(e, "touchmove", u),
                    t.event.bind(e, "touchend", d)) : R.supportsIePointer && (window.PointerEvent ? (t.event.bind(e, "pointerdown", h),
                    t.event.bind(e, "pointermove", u),
                    t.event.bind(e, "pointerup", d)) : window.MSPointerEvent && (t.event.bind(e, "MSPointerDown", h),
                    ...
                    if (c(l)) {
                        ...
                        function(n, o) {
                            var r = Math.floor(e.scrollTop)
                              ...
                              , s = Math.abs(o);
                            if (s > l) {
                                if (o < 0 && r === t.contentHeight - t.containerHeight || o > 0 && 0 === r)
                                    return 0 === window.scrollY && o > 0 && R.isChrome
                            } else if (l > s && (n < 0 && i === t.contentWidth - t.containerWidth || n > 0 && 0 === i))
                                return !0;
                            return !0
                ...
                function d() {
                    ...
                    l = setInterval((function() {
                        t.isInitialized ? clearInterval(l) : i.x || i.y ? Math.abs(i.x) < .01 && Math.abs(i.y) < .01 ? clearInterval(l) : t.element ? (s(30 * i.x, 30 * i.y),
                        i.x *= .8,
                        i.y *= .8) : clearInterval(l) : clearInterval(l)
                    }
                    ), 10))
                }
            }
          ...
          , L = function(t, e) {
            ...
            !0 === this.isRtl && t.classList.add(u),
            ...
            var c = o(this.scrollbarXRail);
            this.scrollbarXBottom = parseInt(c.bottom, 10),
            isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1,
            this.scrollbarXTop = X(c.top)) : this.isScrollbarXUsingBottom = !0,
            this.railBorderXWidth = X(c.borderLeftWidth) + X(c.borderRightWidth),
            r(this.scrollbarXRail, {
                display: "block"
            }),
            this.railXMarginWidth = X(c.marginLeft) + X(c.marginRight),
            r(this.scrollbarXRail, {
                display: ""
            }),
            ...
            this.railBorderYWidth = X(f.borderTopWidth) + X(f.borderBottomWidth),
            r(this.scrollbarYRail, {
                display: "block"
            }),
            this.railYMarginHeight = X(f.marginTop) + X(f.marginBottom),
            r(this.scrollbarYRail, {
                display: ""
            }),
        ...
        L.prototype.update = function() {
            ...
            this.railXMarginWidth = X(o(this.scrollbarXRail).marginLeft) + X(o(this.scrollbarXRail).marginRight),
            this.railYMarginHeight = X(o(this.scrollbarYRail).marginTop) + X(o(this.scrollbarYRail).marginBottom),
            r(this.scrollbarXRail, {
                display: "none"
            }),
            r(this.scrollbarYRail, {
    ...
    48178: function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        });
        var o, r = n(12917), i = (o = r) && o.__esModule ? o : {
            default: o
        };
        e.default = i.default,
        t.exports = e.default
            ...
            r(e, [{
                ...
                value: function() {
                    ...
                    t.children)
                      ...
                      , s = n;
                    return l.default.createElement(s, o({
                        style: e,
                        ref: this.handleRef
                    }, i), r)
                }
